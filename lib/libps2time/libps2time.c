...
Copyright (C) 2006 Torben Koenke
...
/*
	ps2time_setTimezone - sets the timezone as offset in minutes from
	GMT. This is here because I can't get configGetTimezone to work
	properly.
*/
